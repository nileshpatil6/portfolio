    ...
    if (command === "help") {
      addHistory({
        output: [
          "Available commands:",
          "",
          "  whoami          — Display identity and credentials",
          "  ls [path]       — List directory contents",
          "  ls -la          — Detailed listing",
          "  cd [dir]        — Change directory",
          "  cat [file]      — Display file contents",
          "  nano [project]  — Open project in editor (ESC to close)",
          "  git log         — View git history",
          "  git status      — View git status",
          "  neofetch        — System information",
          "  curl nilesh.dev/skills  — View skills JSON",
          "  ssh nilesh@portfolio.dev — Remote access",
          "  ping google.com  — Network test",
          "  sudo rm -rf boring-portfolio/",
          "  clear           — Clear terminal",
          "  exit            — Return to mode select",
          "",
          "Pro tip: Use arrow keys for command history, Tab to autocomplete project names",
        ],
        type: "info",
      });
      return;
